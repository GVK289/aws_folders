...
# class AddDataForStateDailyWiseReportInteractor:
...
#     def add_data_for_state_daily_wise_report(
#             self,
#             state_id: int,
...
#         daily_state_wise_report_dto = self.state_storage. \
...
#             get_response_add_data_for_state_daily_wise_report(
